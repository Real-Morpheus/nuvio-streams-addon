...
conn.on('ready', () => {
    ...
    conn.sftp((err, sftp) => {
        ...
        sftp.fastPut('c:\\Users\\Administrator\\Desktop\\linux-deployment\\debug_proxy_chain.js', '/opt/nuvio-deployment/nuvio-addon/debug_proxy_chain.js', (err) => {
            ...
            const cmd = 'docker cp /opt/nuvio-deployment/nuvio-addon/debug_proxy_chain.js nuvio-streams-app:/app/debug_proxy_chain.js && docker exec nuvio-streams-app node debug_proxy_chain.js';
